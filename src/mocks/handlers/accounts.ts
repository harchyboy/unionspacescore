...
const mockCompanies: Company[] = [
  {
    ...
    contactCount: 3,
    contacts: [
      { id: '1', name: 'James Parker', email: 'j.parker@knightfrank.com', role: 'Senior Partner' },
      { id: 'kf-2', name: 'Sarah Williams', email: 's.williams@knightfrank.com', role: 'Associate Director' },
      { id: 'kf-3', name: 'Tom Richardson', email: 't.richardson@knightfrank.com', role: 'Partner' },
    ],
    activeDeals: 5,
    totalDeals: 28,
  ...
  },
  {
    ...
    contactCount: 2,
    contacts: [
      { id: '2', name: 'Marcus Reynolds', email: 'marcus.reynolds@savills.com', role: 'Senior Partner' },
      { id: 'sav-2', name: 'Emily Carter', email: 'e.carter@savills.com', role: 'Director' },
    ],
    activeDeals: 3,
    totalDeals: 22,
    relationshipHealth: 'excellent',
  ...
  },
  {
    ...
    contactCount: 4,
    contacts: [
      { id: 'cbre-1', name: 'Michael Thompson', email: 'm.thompson@cbre.com', role: 'Managing Director' },
      { id: 'cbre-2', name: 'Jennifer Lewis', email: 'j.lewis@cbre.com', role: 'Senior Vice President' },
      { id: 'cbre-3', name: 'Robert Chen', email: 'r.chen@cbre.com', role: 'Director' },
      { id: 'cbre-4', name: 'Amanda Foster', email: 'a.foster@cbre.com', role: 'Associate' },
    ],
    activeDeals: 7,
    totalDeals: 35,
    relationshipHealth: 'excellent',
  ...
  },
  {
    ...
    contactCount: 3,
    contacts: [
      { id: 'jll-1', name: 'David Wright', email: 'd.wright@jll.com', role: 'Head of Office Agency' },
      { id: 'jll-2', name: 'Sophie Adams', email: 's.adams@jll.com', role: 'Director' },
      { id: 'jll-3', name: 'Chris Martin', email: 'c.martin@jll.com', role: 'Associate Director' },
    ],
    activeDeals: 4,
    totalDeals: 18,
  ...
  },
  {
    ...
    contactCount: 2,
    contacts: [
      { id: 'cw-1', name: 'Peter Brown', email: 'p.brown@cushwake.com', role: 'Managing Partner' },
      { id: 'cw-2', name: 'Rachel Green', email: 'r.green@cushwake.com', role: 'Senior Director' },
    ],
    activeDeals: 2,
    totalDeals: 12,
    relationshipHealth: 'good',
  ...
  },
  {
    ...
    contactCount: 2,
    contacts: [
      { id: 'col-1', name: 'Andrew Mitchell', email: 'a.mitchell@colliers.com', role: 'Director' },
      { id: 'col-2', name: 'Laura Hughes', email: 'l.hughes@colliers.com', role: 'Associate Director' },
    ],
    activeDeals: 1,
    totalDeals: 8,
    relationshipHealth: 'good',
